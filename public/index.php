  ...
  <body class="home" data-app="Home"><?php include $_SERVER['DOCUMENT_ROOT'] . '/includes/header.php' ?>
    <main class="main" id="pageTop">
      <div class="js-contents" id="js-contents">
        <h1>h1</h1>
        <picture>
          <source srcset="/assets/images/example/dummy-pc.jpg.webp" media="(min-width: 768px)" width="800" height="400" type="image/webp"/>
          <source srcset="/assets/images/example/dummy-pc.jpg" media="(min-width: 768px)" width="800" height="400"/>
          <source srcset="/assets/images/example/dummy.jpg.webp" width="375" height="600" type="image/webp"/><img src="/assets/images/example/dummy.jpg" width="375" height="600" decoding="async" alt=""/>
        </picture>
      </div>
